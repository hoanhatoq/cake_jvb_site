    ...
    <script>
        ...
        <div class="menu_top">
            <ul>
                    ...
                    <li class="" ><a href="<?php echo $this->Html->url(array('controller' => 'about_us', 'action' => 'index')) ?>"><?php echo __('Giới thiệu');?></a></li>
                
                            
                    <li class="" ><a href="<?php echo $this->Html->url(array('controller' => 'service', 'action' => 'index')) ?>"><?php echo __('Dịch vụ');?></a></li>
                    
                            
                    <li class="" ><a href="<?php echo $this->Html->url(array('controller' => 'news', 'action' => 'index')) ?>"><?php echo __('Tin tức');?></a></li>
...
<div class="readmore"><a href="#"><?php echo __('Xem thêm');?></a></div>
                ...
                <div class="im_slide">
                    <?php 
                        echo $this->Html->image(__('banner2.png'), array('class'=> 'lazy', 'alt' => 'banner_mobile')); 
                    ?>
                </div>
            </li>
...
<div class="readmore"><a href="#"><?php echo __('Xem thêm');?></a></div>
                ...
                <div class="im_slide">
                    <?php 
                        echo $this->Html->image(__('banner1.png'), array('class'=> 'lazy', 'alt'=> 'banner_mobile')); 
                    ?>
                </div>
            </li>
...
<div class="readmore"><a href=""><?php echo __('Xem thêm');?></a></div>
                ...
                <div class="im_slide">
                    <?php 
                        echo $this->Html->image(__('banner3.png'), array('class'=> 'lazy', 'alt'=> 'banner_mobile')); 
                    ?>
                </div>
            </li>
